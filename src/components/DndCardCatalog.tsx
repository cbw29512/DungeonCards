  ...
  return (
    <div className="dnd-card-catalog">
      <section className="dnd-card-catalog__edition" aria-labelledby="dnd-card-catalog-edition-title">
        <div><small>Exact-edition boundary</small><h1 id="dnd-card-catalog-edition-title">Choose the D&D Card Catalog</h1><p>Rules, spells, monsters, characters, homebrew, and imports stay inside one edition.</p></div>
      ...
      <CardCatalogWorkspace catalog={catalog} sourceActions={actions} />
    </div>
  );
};
