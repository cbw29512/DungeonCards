...
const templates: DndTemplate[] = [
  ...
  { id: "gear-catalog", category: "Equipment", title: "Tools, remaining adventuring gear, waterborne vehicles, and item procedures", status: "missing", summary: "The remaining licensed equipment catalog and item-specific Utilize procedures are not yet organized into a searchable workspace.", nextStep: "Import edition-separated tools, remaining adventuring gear, waterborne vehicles, costs, weights, and licensed procedures." },
