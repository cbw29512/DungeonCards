...
const templates: DndTemplate[] = [
  ...
  { id: "initiative-turns", category: "Combat", title: "Initiative, turns, actions, movement, and reactions", status: "automation-complete", summary: "The live encounter board sorts Initiative, preserves manual tie order, advances rounds and turns, refreshes Reactions, spends Action and Bonus Action resources, tracks movement, and separates 2014 and 2024 surprise procedures.", nextStep: "Connect combatants to persistent HP, conditions, and monster stat blocks.", route: "?system=dnd&page=combat" },
  { id: "concentration", category: "Combat", title: "Concentration and damage checks", status: "automation-complete", summary: "Combatants can start, replace, and end concentration; each damage source receives its own Constitution save with the correct edition formula and the 2024 DC 30 cap.", nextStep: "Connect incapacitation and death events directly from the health and condition trackers.", route: "?system=dnd&page=combat" },
  ...
  { id: "campaign-tracking", category: "GM operations", title: "Initiative, concentration, condition, and effect tracking", status: "procedure-complete", summary: "A live encounter board now tracks Initiative, rounds, turns, Action economy, movement, Reactions, surprise, and concentration, while health and condition records remain separate workspaces.", nextStep: "Unify HP, conditions, durations, save-at-end effects, and monster references into each combatant record.", route: "?system=dnd&page=combat" },
