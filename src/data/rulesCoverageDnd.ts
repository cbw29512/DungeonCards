...
const templates: DndTemplate[] = [
  ...
  { id: "initiative-turns", category: "Combat", title: "Initiative, turns, actions, movement, and reactions", status: "automation-complete", summary: "The live encounter board sorts Initiative, preserves manual tie order, advances rounds and turns, refreshes Reactions, spends Action and Bonus Action resources, tracks movement, and separates 2014 and 2024 surprise procedures.", nextStep: "Add position, target, distance, and reach validation.", route: "?system=dnd&page=combat" },
  ...
  { id: "monster-encounter-import", category: "Creatures", title: "SRD monster encounter import", status: "automation-complete", summary: "Every edition-matched SRD monster can be added to live combat with editable HP, Speed, Dexterity, and Initiative plus sourced AC, saves, senses, complete action sections, reach/range quick references, action-economy gates, and independent per-copy recharge state.", nextStep: "Add target selection, attack and save execution, damage application, grid distance, and legendary-action budgets.", route: "?system=dnd&page=combat" },
  ...
  { id: "campaign-tracking", category: "GM operations", title: "Initiative, HP, concentration, condition, and effect tracking", status: "automation-complete", summary: "The live encounter board tracks Initiative, rounds, turns, Action economy, movement, Reactions, surprise, HP, Temporary HP, Death Saves, concentration, conditions, timed effects, save-to-end checks, complete SRD monster imports, sourced monster actions, and recharge state.", nextStep: "Add Exhaustion, condition-derived restrictions, target and position tracking, executable monster rolls, and persistent local session saves.", route: "?system=dnd&page=combat" },
