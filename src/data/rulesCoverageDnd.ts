...
const templates: DndTemplate[] = [
  ...
  { id: "initiative-turns", category: "Combat", title: "Initiative, turns, actions, movement, and reactions", status: "automation-complete", summary: "The live encounter board sorts Initiative, preserves manual tie order, advances rounds and turns, refreshes Reactions, spends Action and Bonus Action resources, tracks movement, and separates 2014 and 2024 surprise procedures.", nextStep: "Connect combatants to persistent HP and monster stat blocks.", route: "?system=dnd&page=combat" },
  { id: "concentration", category: "Combat", title: "Concentration and damage checks", status: "automation-complete", summary: "Combatants can start, replace, and end concentration; each damage source receives its own Constitution save with the correct edition formula and the 2024 DC 30 cap. Incapacitating conditions applied in the encounter board automatically end concentration.", nextStep: "Connect death and incapacitation events directly from the health tracker.", route: "?system=dnd&page=combat" },
  ...
  { id: "campaign-tracking", category: "GM operations", title: "Initiative, concentration, condition, and effect tracking", status: "automation-complete", summary: "The live encounter board tracks Initiative, rounds, turns, Action economy, movement, Reactions, surprise, concentration, combatant-owned conditions, timed effects, and save-to-end checks.", nextStep: "Unify HP, Exhaustion, monster references, and condition-derived restrictions into each combatant record.", route: "?system=dnd&page=combat" },
