...
const templates: DndTemplate[] = [
  ...
  { id: "gear-catalog", category: "Equipment", title: "Tools, adventuring gear, containers, packs, waterborne vehicles, and item procedures", status: "missing", summary: "The remaining licensed equipment catalog and item-specific Utilize procedures are not yet organized into a searchable workspace.", nextStep: "Import edition-separated tools, gear, containers, packs, waterborne vehicles, costs, weights, capacities, and licensed procedures." },
