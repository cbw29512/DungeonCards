...
const templates: DndTemplate[] = [
  ...
  { id: "initiative-turns", category: "Combat", title: "Initiative, turns, actions, movement, and reactions", status: "automation-complete", summary: "The live encounter board sorts Initiative, preserves manual tie order, advances rounds and turns, refreshes Reactions, spends Action and Bonus Action resources, tracks movement, and separates 2014 and 2024 surprise procedures.", nextStep: "Connect combatants to monster stat blocks and position/reach data.", route: "?system=dnd&page=combat" },
