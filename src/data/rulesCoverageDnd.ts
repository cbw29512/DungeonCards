...
const templates: DndTemplate[] = [
  ...
  { id: "gear-catalog", category: "Equipment", title: "Tools, adventuring gear, containers, packs, mounts, and vehicles", status: "missing", summary: "The complete licensed equipment catalog and item-specific Utilize procedures are not yet organized into a searchable workspace.", nextStep: "Import edition-separated tools, gear, containers, packs, mounts, and vehicles with costs, weights, capacities, and licensed procedures." },
