...
const templates: DndTemplate[] = [
  ...
  { id: "initiative-turns", category: "Combat", title: "Initiative, turns, actions, movement, and reactions", status: "automation-complete", summary: "The live encounter board sorts Initiative, preserves manual tie order, advances rounds and turns, refreshes Reactions, spends Action and Bonus Action resources, tracks movement, and separates 2014 and 2024 surprise procedures.", nextStep: "Add position, reach, and action-selection data to each combatant.", route: "?system=dnd&page=combat" },
  ...
  { id: "monster-encounter-import", category: "Creatures", title: "SRD monster encounter import", status: "automation-complete", summary: "Every edition-matched SRD monster can be searched and added to the live encounter with source-linked, editable Hit Points, walking Speed, Dexterity modifier, quantity, and shared or separate Initiative rolls.", nextStep: "Attach parsed actions, AC, saves, senses, and recharge state to imported combatants.", route: "?system=dnd&page=combat" },
  ...
  { id: "campaign-tracking", category: "GM operations", title: "Initiative, HP, concentration, condition, and effect tracking", status: "automation-complete", summary: "The live encounter board tracks Initiative, rounds, turns, Action economy, movement, Reactions, surprise, combatant HP and Temporary HP, Death Saves, concentration, conditions, timed effects, save-to-end checks, and complete SRD monster imports.", nextStep: "Add Exhaustion, condition-derived restrictions, position/reach, action selection, and persistent local session saves.", route: "?system=dnd&page=combat" },
