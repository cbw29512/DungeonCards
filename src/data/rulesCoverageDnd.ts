...
const templates: DndTemplate[] = [
  ...
  { id: "weapon-mastery", category: "Equipment", title: "Weapon Mastery properties", status: "automation-complete", summary: "All eight SRD 5.2.1 properties and all 39 weapon assignments are searchable and source-linked, with an unlock gate, Topple DC calculator, and Cleave/Nick turn tracking.", route: "?system=dnd&page=mastery", only: "dnd-2024" },
  ...
  { id: "non-srd", category: "Owned content", title: "Paid-book and non-SRD content", status: "requires-owned-source", summary: "DM Forge cannot republish protected book content. A private user-owned import layer is required.", nextStep: "Add private structured imports that never publish source text." }
];
