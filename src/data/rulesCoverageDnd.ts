...
const templates: DndTemplate[] = [
  ...
  { id: "movement-special-attacks", category: "Combat", title: "Movement, cover, grappling, shoving, and special attacks", status: "missing", summary: "These rules are not yet covered as a complete edition-separated procedure set.", nextStep: "Add movement and special-attack procedure cards." },
  ...
  { id: "conditions", category: "Combat", title: "Conditions and exhaustion", status: "missing", summary: "A complete searchable and printable conditions library is not yet available.", nextStep: "Build edition-specific condition cards and effect timers." },
