...
export const dndToolCatalog: DndToolDefinition[] = [
  ...
  { id: "smith", name: "Smith’s Tools", category: "artisan", costCp: 2000, weightPounds: 8, ability2024: "Strength", utilize2024: ["Pry open a door or container (DC 20)"], craft2024: ["Melee weapons except Club, Greatclub, Quarterstaff, and Whip", "Medium armor except Hide", "Heavy armor", "Ball Bearings", "Bucket", "Caltrops", "Chain", "Crowbar", "Firearm Bullets", "Grappling Hook", "Iron Pot", "Iron Spikes", "Sling Bullets"], procedure2014: artisanProcedure },
  ...
  { id: "woodcarver", name: "Woodcarver’s Tools", category: "artisan", costCp: 100, weightPounds: 5, ability2024: "Dexterity", utilize2024: ["Carve a pattern in wood (DC 10)"], craft2024: ["Club", "Greatclub", "Quarterstaff", "Ranged weapons except Pistol, Musket, and Sling", "Arcane Focus", "Arrows", "Bolts", "Druidic Focus", "Ink Pen", "Needles"], procedure2014: artisanProcedure },
