...
export const fighterMagicItemsForLevel = (
  ...
  const common = [
    item(ruleset, "potion-healing", "Potion of Healing", "common", 2, {
      ...
      effectSummary: "Restores 2d4 + 2 Hit Points as a combat-ready consumable.",
    ...
    item(ruleset, "potion-climbing", "Potion of Climbing", "common", 11, {
      category: "potion", requiresAttunement: false, attunedByDefault: false, consumable: true,
      effectSummary: "Grants a Climb Speed equal to Speed for 1 hour and Advantage on Athletics checks to climb.",
  ...
  const uncommon = [
    ...
    item(ruleset, "bag-holding", "Bag of Holding", "uncommon", 11, {
      ...
      effectSummary: "Stores up to 500 pounds of gear in extradimensional space.",
    ...
    item(ruleset, "winged-boots", "Winged Boots", "uncommon", 17, {
      ...
      maximumCharges: 4, recharge: "Regains 1d4 expended charges daily at dawn.",
      effectSummary: "Spend 1 charge as a Magic action to gain a 30-foot Fly Speed for 1 hour.",
  ...
  const rare = [
    item(ruleset, "ring-protection", "Ring of Protection", "rare", 11, {
      ...
      effectSummary: "Grants +1 Armor Class and +1 to saving throws while worn.",
      synergyNote: "Reinforces front-line durability and weak mental saves."
    }),
    ...
    item(ruleset, "bead-force", "Bead of Force", "rare", 17, {
      ...
      effectSummary: "Creates a compact force blast and can briefly contain creatures caught inside.",
  ...
  const veryRare = [
    item(ruleset, "frost-brand", "Frost Brand", "very-rare", 17, {
      ...
      effectSummary: "Adds 1d6 Cold damage on hits and grants Fire Resistance while held.",
