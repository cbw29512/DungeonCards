...
const expectUniqueIds = (entries: CardCatalogEntry[]) => {
...
const expectExactSystem = (
  ...
  expectUniqueIds(catalog.entries);
...
describe("unified exact-system Card Catalog sources", () => {
  it("assembles complete isolated D&D 2014 and 2024 catalogs without dropping scaled cards", () => {
  ...
  it("assembles verified and original CoC 7e sources without duplicate IDs or crossed systems", () => {
