...
export const createFightBattle = (
  ...
  return {
    ...
    round: 1,
    activeIndex: 0,
    character: { profile: character, currentHitPoints: character.hitPoints, activeEffects: [] },
    monster: { profile: monster, currentHitPoints: monster.hitPoints, activeEffects: [] },
    events: []
  };
};
